import {
  ...
  IpcInstallPlugin,
  IpcUninstallPlugin,
  IpcCheckPluginUpdate,
  IpcGetRunningPlugins,
...
export default Object.assign(mainObj, {
  ...
  createPluginShortcut: invoke<IpcCreatePluginShortcut>('createPluginShortcut'),
  ...
  getRunningPlugins: invoke<IpcGetRunningPlugins>('getRunningPlugins'),
