...
const STORAGE_FOCUS_TIME = 'focusTime'
const STORAGE_SHORT_BREAK_TIME = 'shortBreakTime'
const STORAGE_LONG_BREAK_TIME = 'longBreakTime'
const STORAGE_TOTAL_FOCUS_COMPLETED = 'totalFocusCompleted'
