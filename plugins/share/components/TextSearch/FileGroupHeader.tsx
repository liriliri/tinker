...
function FileGroupHeader({ group, collapsed }: FileGroupHeaderProps) {
  ...
  return (
    <div
      ...
      className={`flex items-center cursor-pointer text-xs ${tw.hover}`}
      style={{
...
export default memo(FileGroupHeader)
